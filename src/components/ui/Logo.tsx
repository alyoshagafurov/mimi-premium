...
/**
 * mimi wordmark — plain lime "mimi" using the font's own letters (natural i-dots).
 */
export function Logo({
  ...
  return (
    <Link href={href} className={cn('group inline-flex flex-col items-start leading-none', className)}>
      <span className={cn('font-display font-extrabold tracking-tight text-brand-lime', wordMap[size])}>
        mimi
      </span>
      {subtitle && (
