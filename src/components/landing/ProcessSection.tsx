...
const ru = {
  ...
  steps: [
    ...
    { title: 'Маркетинговая стратегия', desc: 'Классический и digital-маркетинг на следующие 3–6 месяцев.', detail: 'Дорожная карта с приоритетами, бюджетами и KPI по каждому каналу. Не презентация — рабочий документ.' },
    { title: 'Продюсирование', desc: 'Превращаем стратегию в готовый к запуску контент и креативы.', detail: 'Сценарии, съёмки, монтаж, продающие креативы. Собираем всё, что нужно для старта рекламы.' },
    { title: 'Запуск', desc: 'Подбираем платформы под вашу нишу и запускаем рекламу — с понятной аналитикой и отчётностью.', detail: 'Собираем всё в систему: рекламные кампании, UTM-разметку и дашборд аналитики.' },
...
const en: typeof ru = {
  ...
  steps: [
    ...
    { title: 'Marketing strategy', desc: 'Classic and digital marketing for the next 3–6 months.', detail: 'A roadmap with priorities, budgets and KPIs per channel. Not a presentation — a working document.' },
    { title: 'Production', desc: 'We turn strategy into launch-ready content and creatives.', detail: 'Scripts, shooting, editing, selling creatives. Everything needed to start advertising.' },
    { title: 'Launch', desc: 'We pick the platforms that fit your niche and launch ads — with clear analytics and reporting.', detail: 'We assemble it into a system: ad campaigns, UTM tagging and an analytics dashboard.' },
...
const tg: typeof ru = {
  ...
  steps: [
    ...
    { title: 'Стратегияи маркетингӣ', desc: 'Маркетинги классикӣ ва рақамӣ барои 3–6 моҳи оянда.', detail: 'Нақшаи роҳ бо афзалиятҳо, буҷетҳо ва KPI барои ҳар канал. На презентатсия — ҳуҷҷати корӣ.' },
    { title: 'Продюсерӣ', desc: 'Стратегияро ба контент ва креативҳои омода ба оғоз табдил медиҳем.', detail: 'Сенарияҳо, наворбардорӣ, монтаж, креативҳои фурӯшгар. Ҳама чизи барои оғози реклама лозимро ҷамъ мекунем.' },
    { title: 'Оғоз', desc: 'Платформаҳои мувофиқи нишаи шуморо интихоб карда, рекламаро оғоз мекунем — бо аналитика ва ҳисоботи фаҳмо.', detail: 'Ҳамаро ба система ҷамъ мекунем: маъракаҳои реклама, разметкаи UTM ва дашборди аналитика.' },
