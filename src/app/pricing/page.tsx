...
const PLANS = [
  {
    ...
    features: [
      ...
      'Аналитика и понятные отчёты (Excel)',
      'До 8 рекламных креативов',
      '4 продающих Reels',
      'Контент-направление: что снимать, для кого и с какой целью',
    ],
    cta: 'Выбрать PRO',
  },
  {
  ...
  },
  {
    ...
    features: [
      'Маркетинговая стратегия и рост-план',
      'Полный брендинг: брендбук + дизайн мерча',
      'Таргетированная реклама + глубокая аналитика',
      'Систематизация бизнес-процессов',
      'До 15 рекламных креативов',
      '8–10 продающих Reels',
      'Чёткие форматы контента (стратегия + направление)',
      'Консультации отдела продаж',
      'Веб-страница — в подарок',
      'Постоянное участие на всех этапах роста',
      'Масштабирование через соцсети, ТВ и наружную рекламу',
    ],
    cta: 'Выбрать ELITE',
  },
];
